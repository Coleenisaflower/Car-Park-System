...
class Ticket(Frame):
    def __init__(self, *args, **kwargs):
        ...
        Label(self.frame, text='#0001', font='Bahnschrift 20 bold', bg='#002b3c', fg='white').grid(row=0, column=2,
                                                                                                   padx=0, pady=10,
                                                                                                   sticky=S)
        ...
        row = 1
        for i in range(3):
            Label(self.frame, text=options[i], font=self.font, background='#002b3c', fg='white').grid(row=row, column=0,
                                                                                                      padx=10, pady=8,
                                                                                                      sticky=E)
            row += 1
...
class Counter(Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.no_of_spots_tw = StringVar()
        self.base_fee_tw = StringVar()
        self.added_fee_tw = StringVar()

        self.no_of_spots_fw = StringVar()
        self.base_fee_fw = StringVar()
        self.added_fee_fw = StringVar()
    ...
    def save(self):
        if len(self.no_of_spots_tw.get()) == 0 or len(self.no_of_spots_fw.get()) == 0:
