...
class Ticket(Frame):
    def __init__(self, *args, **kwargs):
        ...
        ticket_type = IntVar()
        self.two_wheelers_type = Radiobutton(type_labelframe, text='Two-wheeler',fg='#ecb365', font=('CenturyGothic', 10, 'bold'),
                                                        variable=ticket_type, value=2,command=NONE)
        self.two_wheelers_type.config(bg='#002b3c')
        self.two_wheelers_type.grid(row=0, column=0, padx=20, pady=10)

        self.four_wheelers_type = Radiobutton(type_labelframe, text='Four-wheeler', variable=ticket_type, value=4,
                                              command=NONE, fg='#ecb365', font=('CenturyGothic', 10, 'bold'))
...
class Counter(Frame):
    def __init__(self, *args, **kwargs):
        ...
        Label(self, text='Two-wheelers :', font='CenturyGothic 10 bold',background='#002b3c', fg='white').grid(row=1, column=0, padx=10, pady=10, sticky=W)
        Label(self, text='23', font='Bahnschrift 19 bold',background='#002b3c', fg='white').grid(row=1, column=1, padx=10, pady=10, sticky=E)

        Label(self, text='Four-wheelers :', font='CenturyGothic 10 bold',background='#002b3c', fg='white').grid(row=2, column=0, padx=10, pady=10, sticky=W)
...
class Menu(Frame):
    ...
    def manageAttendants(self):
        ...
        Label(right_frame, text='Add Attendant', font='Bahnschrift 15').grid(row=0, columnspan=2, padx=5, pady=10,
                                                                             sticky=W)
    ...
    def manageChangeAttendant(self):
        ...
        connect.commit()
        '''
        self.course_drop = ttk.Combobox(self.change_win, values=['Attendant 1', 'Attendant 2', 'Attendant 3'],
                                        state='readonly')
